...
<?php require 'partials/_nav.php' ?>
    ...
    <div class="card text-center ">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-outline-success"  type="button">Bharat Borude</button>
        </div>
        <script>
function myfunction(){
  document.getElementByclass("btn").style.background="black";
  alert("<div class='bg-light text-primary'> Procesing to Developer Page</div>");
}
        </script>
